              ...
              @endif --}}
                        ...
                        <div class="card-header">
                            <form id="form" action="{{ route('product.store') }}" method="post"
                                ...
                                @csrf
                                <div class="mb-2">
                                    <label for="namaProduk" class="form-label">Nama Produk<span
                                ...
                                <div class="mb-2 form-group">
                                    <label for="namaProduk" class="form-label">Kategori<span
                                            style="color: red;">*</span></label>
                                ...
                                <div class="mb-2">
                                    <label for="diskon" class="form-label">Diskon<span
                                            style="color: red;">*</span></label>
